...
extension APIRequest {
    ...
    func requestWithBaseUrl() -> URLRequest {
        /*
         si hay parametros en la url añadimos el {parametro} y ya hace todo automáticamenteno? Luego haríamos parameters : { return ["parametro" : "parametro"]}
        ...
        request.addValue("madelatorre", forHTTPHeaderField: "Api-Username")
